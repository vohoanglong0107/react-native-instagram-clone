...
// TODO change to StoryProcessedImageInFireStore to navigate.
    ...
    <PanGestureHandler
      ...
      <View>
                    ...
                    <Animated.View
                      style={{
                        ...
                        transform: [
                          ...
                          {
                            rotate: _rotateAnimList[index].interpolate({
                              inputRange: [-100, 100],
        ...
        <Animated.View
          ...
          <View style={styles.labelOptionsBlurView}>
